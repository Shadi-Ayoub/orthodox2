<?php
    switch($category){
        ...
        case "danger":
            ...
            $link = "#exclamation-triangle-fill";
            $aria_label = "Danger";
            break;
    ...
    $dismissible = $dismissible ? "alert-dismissible" : "";

    echo $symbol;
?>

<div class="alert alert-<?= $category; ?> <?= $dismissible; ?> d-flex align-items-center fade show" role="alert">
    <?php
        if($icon) {
    ?>
            <svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img" aria-label="<?= $aria_label; ?>"><use xlink:href="<?= $link; ?>"/></svg>
    <?php
        }
    ?>
